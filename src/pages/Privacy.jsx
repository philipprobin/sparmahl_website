const Privacy = () => {
    return (
        <>
        <h1 className="text-3xl font-bold">Datenschutz&shy;erkl&auml;rung</h1>
    <h2 className="text-2xl font-bold">1. Datenschutz auf einen Blick</h2>
    <h3 className="text-1xl font-bold">Allgemeine Hinweise</h3>
    ...
    <h3 className="text-1xl font-bold">Datenerfassung auf dieser Website</h3>
    <h4 className="text-0.5xl font-bold">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
    <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten k&ouml;nnen Sie
        ...
        entnehmen.</p>
    <h4 className="text-0.5xl font-bold">Wie erfassen wir Ihre Daten?</h4>
    ...
    <h4 className="text-0.5xl font-bold">Wof&uuml;r nutzen wir Ihre Daten?</h4>
    ...
    <h4 className="text-0.5xl font-bold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
    ...
    <h3 className="text-1xl font-bold">Strato</h3>
    ...
    <h2 className="text-2xl font-bold">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
    <h3 className="text-1xl font-bold">Datenschutz</h3>
    ...
    <h3 className="text-1xl font-bold">Hinweis zur verantwortlichen Stelle</h3>
    <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p>
    <p>Moritz Staat<br/>
        Alter M&uuml;hlenweg 41<br/>
        44139 Dortmund</p>

    <p>Telefon: 023143898235<br/>
        E-Mail: moritz.staat@sparmahl.de</p>
    ...
    <h3 className="text-1xl font-bold">Speicherdauer</h3>
    ...
    <h3 className="text-1xl font-bold">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
    ...
    <h3 className="text-1xl font-bold">Empfänger von personenbezogenen Daten</h3>
    ...
    <h3 className="text-1xl font-bold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
    ...
    <h3 className="text-1xl font-bold">Widerspruchsrecht gegen die Datenerhebung in besonderen F&auml;llen sowie gegen Direktwerbung (Art. 21
        DSGVO)</h3>
    ...
    <h3 className="text-1xl font-bold">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
    ...
    <h3 className="text-1xl font-bold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
    ...
    <h3 className="text-1xl font-bold">Auskunft, Berichtigung und L&ouml;schung</h3>
    <p>Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche
        ...
        der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder L&ouml;schung dieser Daten. Hierzu sowie zu
        weiteren Fragen zum Thema personenbezogene Daten k&ouml;nnen Sie sich jederzeit an uns wenden.</p>
    <h3 className="text-1xl font-bold">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
    ...
    <h3 className="text-1xl font-bold">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
    ...
    <h3 className="text-1xl font-bold">Cookies</h3>
    ...
    <p>Welche Cookies und Dienste auf dieser Website eingesetzt werden, k&ouml;nnen Sie dieser Datenschutzerkl&auml;rung
        entnehmen.</p>
    <h3 className="text-1xl font-bold">Server-Log-Dateien</h3>
    ...
    <h3 className="text-1xl font-bold">Kontaktformular</h3>
    ...
    <h3 className="text-1xl font-bold">Anfrage per E-Mail, Telefon oder Telefax</h3>
    ...
    <h2 className="text-2xl font-bold">5. Newsletter</h2>
    <h3 className="text-1xl font-bold">Newsletter&shy;daten</h3>
    ...
    <p>Die Verarbeitung der in das Newsletteranmeldeformular eingegebenen Daten erfolgt ausschlie&szlig;lich auf
        ...
        erfolgten Datenverarbeitungsvorg&auml;nge bleibt vom Widerruf unber&uuml;hrt.</p>
    ...
    <h2 className="text-2xl font-bold">6. Plugins und Tools</h2>
    <h3 className="text-1xl font-bold">Font Awesome (lokales Hosting)</h3>
    ...
    <h3 className="text-1xl font-bold">MyFonts</h3>
    <p>Diese Seite nutzt MyFonts. Hierbei handelt es sich um Schriftarten, die beim Aufrufen unserer Website in Ihren
        Browser geladen werden, um ein einheitliches Schriftbild bei der Webseitendarstellung zu gew&auml;hrleisten.
        Anbieter ist die Monotype Imaging Holdings Inc., 600 Unicorn Park Drive, Woburn, Massachusetts 01801, USA.</p>
    <p>Um die Einhaltung der Lizenzbedingungen und die Anzahl der monatlichen Seitenaufrufe
        zu &uuml;berpr&uuml;fen, &uuml;bertr&auml;gt MyFonts Ihre IP-Adresse zusammen mit der URL unserer Webseite und
        unseren Vertragsdaten auf seine Server in den USA. Ihre IP-Adresse wird laut Monotype unmittelbar nach
        der &Uuml;bertragung anonymisiert, sodass kein Personenbezug mehr hergestellt werden kann (Anonymisierung).</p>
    ...
    <p>Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US Data Privacy
        ...
        Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: <a
            href="https://www.dataprivacyframework.gov/s/participant-search/participant-detail?id=a2z3d0000001so6AAA&status=Active"
            target="_blank"
            rel="noopener noreferrer">https://www.dataprivacyframework.gov/s/participant-search/participant-detail?id=a2z3d0000001so6AAA&status=Active</a>
    </p>
